...
class pe_features():
    ...
    def extract_dos_header(self,pe,filepath):
    ...
    def extract_file_header(self,pe,filepath):	
    ...
    def extract_optional_header(self,pe,filepath):
    ...
    def extract_all(self,filepath):
        ...
        try:
            ...
            dos_h=self.extract_dos_header(pe,filepath)
            if dos_h==0:
                return 0
            else:
                data+=dos_h

            file_h= self.extract_file_header(pe,filepath)
            if file_h==0:
                return 0
            else:
                data+=file_h

            op_h= self.extract_optional_header(pe,filepath)
            if op_h==0:
                return 0
            else:
                data+=op_h
