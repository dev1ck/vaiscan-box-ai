...
class Node():
  ...
  def save(self):
    ...
    # 파일 IO 오픈
    with open("/home/jodaegeun/websock/"+self.__filename, "wb") as handle:
      # 파일 작성
      handle.write(byte)
    # 콘솔 출력
    print("craete file - /home/jodaegeun/websock/"+self.__filename)
...
start_server = websockets.serve(accept, "192.168.0.161", 8282)
# 비동기로 서버를 대기한다.
